...
def make_robot_from_config(config: RobotConfig) -> Robot:
    ...
    elif config.type == "xlerobot_single_arm":
        from .xlerobot.xlerobot_single_arm import XLerobotSingleArm

        return XLerobotSingleArm(config)
    elif config.type == "xlerobot_single_arm_client":
        from .xlerobot.xlerobot_single_arm_client import XLerobotSingleArmClient

        return XLerobotSingleArmClient(config)
